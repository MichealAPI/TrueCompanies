...
public enum LangKey {
    ...
    PROMOTED("promoted"),
    DEMOTED("demoted"),
    HIRED_TITLE("&a&lHired"),
    FIRED_TITLE("&c&lFired"),
    PROMOTED_TITLE("&a&lPromoted"),
    DEMOTED_TITLE("&#FFAE00&lDemoted"),
    PAYCHECKS("Give Paychecks"),
    CAN_GIVE_PAYCHECKS("&aGive Paychecks: &6%can_give_paychecks%"),
    CANNOT_GIVE_PAYCHECKS("&cYou cannot give Paychecks in this Company."),
    ...
    PAYCHECK_RECEIVED("&aYou received a paycheck of &6%amount%&a from Company &6%company%&a."),
    PAYCHECK_GIVEN("&aYou gave a paycheck of &6%amount%&a to &6%player%&a."),
    ...
    NO_COMPANIES("&cYou are not employed in any Company."),
    TRANSFER_OWNERSHIP_MENU("Transfer %company% to %player%"),
    TRANSFER_OWNERSHIP_CANCELLED("&cYou cancelled the transfer of ownership."),
    TRANSFER_OWNERSHIP_SUCCESS("&aYou transferred ownership of Company &6%company%&a to &6%player%&a."),
